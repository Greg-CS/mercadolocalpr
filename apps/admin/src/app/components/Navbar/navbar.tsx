      ...
      <nav className='bg-[#344E41] w-[100vw] p-8 font-bold text-[#344E41] flex justify-between'>
        ...
        <div className='hidden xl:flex gap-10 items-center'>
          ...
          <div className="dropdown dropdown-end">
                ...
                <ul tabIndex={0} className="mt-3 z-[1] p-2 shadow menu menu-sm dropdown-content bg-base-100 rounded-box w-52">
                  ...
                  <li><div className='text-white'>Settings</div></li>
                  <li><LogoutButton sidePanelStyle={"text-white"}> </LogoutButton></li>
                </ul>
              </div>
        </div>
        <div className='flex xl:hidden'>
          <div className="dropdown dropdown-end">
                ...
                <ul tabIndex={0} className="mt-3 z-[1] p-2 shadow menu menu-sm dropdown-content bg-base-100 rounded-box w-52 gap-4">
                  <li className='pl-3'>  
                    <div className='border-2 rounded-lg p-2 w-[20vw] flex items-center justify-center'>
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="white" className="w-6 h-6">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75" />
                      </svg>
                    </div>
                  ...
                  <li className='pl-3'>
                    <LogoutButton sidePanelStyle={"text-white"}> </LogoutButton>
                  </li>
                </ul>
              </div>
        </div>
